...
class ResponseSchemaDispensersInnerResults(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseSchemaDispensersInnerResults:
        """Create an instance of ResponseSchemaDispensersInnerResults from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseSchemaDispensersInnerResults:
        """Create an instance of ResponseSchemaDispensersInnerResults from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseSchemaDispensersInnerResults.parse_obj(obj)
